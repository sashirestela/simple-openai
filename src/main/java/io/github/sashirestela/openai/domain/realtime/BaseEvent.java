...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = ClientEvent.ConversationItemRetrieve.class,
                name = Realtime.CONVERSATION_ITEM_RETRIEVE),
        ...
        @JsonSubTypes.Type(value = ClientEvent.TranscriptionSessionUpdate.class,
                name = Realtime.TRANSCRIPTION_SESSION_UPDATE),
        ...
        @JsonSubTypes.Type(value = ServerEvent.ConversationItemRetrieved.class,
                name = Realtime.CONVERSATION_ITEM_RETRIEVED),
        ...
        @JsonSubTypes.Type(value = ServerEvent.ConversationItemAudioTransDelta.class,
                name = Realtime.CONVERSATION_ITEM_AUDIO_TRANS_DELTA),
        ...
        @JsonSubTypes.Type(value = ServerEvent.TranscriptionSessionUpdated.class,
                name = Realtime.TRANSCRIPTION_SESSION_UPDATED),
